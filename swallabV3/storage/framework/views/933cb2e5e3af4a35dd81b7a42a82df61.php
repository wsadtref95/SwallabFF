...
<?php $__env->startSection('title', '會員中心->我的訂單'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <div class="row">
            <div class="mySidebar col-2">
                <a href="<?php echo e(url('/login/profile')); ?>">
                    <p>個人檔案</p>
                </a>
                <a href="" class="active">
                    <p>我的訂單</p>
    ...
    <script>
        ...
        function pickupTime() {
            ...
            $.ajax({
                url: "<?php echo e(url('/get-pickup-time')); ?>",
                method: "POST",
                data: {
                    current_time: x,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swallabLa\swallab\resources\views/login/order.blade.php ENDPATH**/ ?>