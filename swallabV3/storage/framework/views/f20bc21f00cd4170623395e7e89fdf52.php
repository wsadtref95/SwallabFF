            ...
            <div class="row justify-content-center w-100 mt-3">
                <div class="col-md-5 d-flex flex-column align-items-center justify-content-center mt-3">
                    <div id="mainImageRest" class="mb-3">
                        <img src="<?php echo e(asset('images/headpage_mainphoto/main_rest.jpeg')); ?>" alt="找餐廳"
                            class="img-fluid">
                    </div>
                ...
                <div class="col-md-5 d-flex flex-column align-items-center justify-content-center mt-3">
                    <div id="mainImageNotes" class="mb-3">
                        <img  src="<?php echo e(asset('images/headpage_mainphoto/main_notes.jpeg')); ?>" alt="看食記"
                            class="img-fluid">
                    </div>
                    <div class="row justify-content-center w-100" id="btnNotes">
                        <a href="<?php echo e(url("")); ?>" class="btn btn-outline-danger text-center w-50">看食記</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swallabLa\swallab\resources\views/headpage/headpage.blade.php ENDPATH**/ ?>