...
<?php $__env->startPush('scripts'); ?>
    <?php echo $__env->make('layouts.map', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
        const assetBaseUrl = "<?php echo e(asset('storage/photos')); ?>";
        const assetBaseUrlShowCart = "<?php echo e(asset('storage/photos')); ?>";
        // 把 Blade 變數轉換為 JSON 格式
        // var restaurants = <?php echo json_encode($restaurants, 15, 512) ?>;
...
<?php $__env->startSection('title', '餐廳內頁'); ?>
...
<div class="container">
    ...
    <div class="container-md mt-5">
        <div class="row">
            ...
            <div class="col-2 custom-ul sticky-top">
                <div class="mb-2 mt-3"  onclick="allfood()">
                    <a href="#all" onclick="filterItems(0)"><img src="<?php echo e(asset('images/other/hot_2.png')); ?>"
                            style="width: 150px;" alt=""></a>
                    <li id="allfood" >全部餐點</li>
                </div>
                <div class="" onclick="limit()">
                    <a href="https://www.google.com.tw/"><img src="<?php echo e(asset('images/other/limited_time_offer.png')); ?>"
                            style="width: 100px;" alt=""></a>
                    <li id="limit">限時優惠</li>
                </div>
                <div class="mb-2 mt-3" onclick="veg()">
                    <a href="#vegetable" onclick="filterItems(19)"><img
                            src="<?php echo e(asset('images/other/vegetable_6.jpeg')); ?>" style="width: 100px;" alt=""></a>
                    <li id="veg">青菜</li>
                </div>


                <div class="mt-2" onclick="dum()">
                    <a href="#dumpling" onclick="filterItems(18)"><img src="<?php echo e(asset('images/other/dumpling.png')); ?>"
                            style="width: 100px; border: none; background-color: transparent;" alt=""></a>
                    <li id="dum">餃類</li>
                </div>
                <div class="mt-2" onclick="ball()">
                    <a href="#porkball" onclick="filterItems(15)"><img src="<?php echo e(asset('images/other/porkball_1.jpg')); ?>"
                            style="width: 100px;" alt=""></a>
                    <li id="ball">丸子</li>
                </div>
                <div class="mt-2 mb-5" onclick="meal()">
                    <a href="#rice" onclick="filterItems(17)"><img src="<?php echo e(asset('images/other/rice.png')); ?>"
            ...
            <div class="col-9 mb-5 ml-5">
                ...
                <div class="row" id="food-list">
                    ...
                    <?php $__currentLoopData = $restaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restaurant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-4 mb-4 restaurant-item" data-class="<?php echo e($restaurant->class); ?>">
                            <img class="ml-3 myimg"
                                src="<?php echo e(url('http://localhost/swallabLa/swallab/storage/app/public/photos/' . $restaurant->photo)); ?>"
                                alt="<?php echo e($restaurant->meals_name); ?>">
                            <div class="name"><?php echo e($restaurant->meals_name); ?></div>
                            <div class="price">$<?php echo e($restaurant->price); ?></div>
                            <button class="score ml-5" data-bs-toggle="modal" data-bs-target="#addCartModal"
                                onclick="addToCart(<?php echo e($restaurant->id); ?>, '<?php echo e($restaurant->meals_name); ?>', <?php echo e($restaurant->price); ?>, '<?php echo e($restaurant->photo); ?>')">
                                加入購物車
                            </button>
        ...
        <div class="row">
            <div class="col-3">
                <img class="ml-2" src="<?php echo e(asset('images/root/LOGO.jpg')); ?>" style="width: 150px;">
            </div>
            <div class="col-9">
                <div>
                ...
                <div class="modal-footer">
                    <div class="d-flex justify-content-between w-100">
                        ...
                        <div style="background-color:rgb(229,166,122);padding:5px 15px;border-radius:10px">
                            <a href="<?php echo e(url('/login/profile/order')); ?>" style="text-decoration: none;color:white">前往購物車</a>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\swallabLa\swallab\resources\views//restaurant/detail.blade.php ENDPATH**/ ?>