                ...
                <div class="container mt-3">
                    <div class="row">
                        <div class="ml-5 d-flex">
                            ...
                            <img src="<?php echo e($user->avatar ? asset('storage/' . $user->avatar) : asset('/images/other/default-avatar.jpg')); ?>"
                            ...
                            <div class="col-md-5 ml-5 ">
                                ...
                                <div class="icon mt-2">
                                    ...
                                    <?php if($user->facebook): ?>
                                        <a href="<?php echo e($user->facebook); ?>" target="_blank" style="text-decoration: none;">
                                    ...
                                    <?php if($user->threads): ?>
                                        <a href="<?php echo e($user->threads); ?>" target="_blank" style="text-decoration: none;">
                            ...
                            <div class="col-md-7 ">
                                ...
                                <a href="<?php echo e(route('profile.edit')); ?>"style="text-decoration: none;" class="btn d-flex delete mx-5">編輯個人檔案</a>
...
<?php /**PATH C:\xampp\htdocs\swallabLa\swallab\resources\views/profile/show.blade.php ENDPATH**/ ?>