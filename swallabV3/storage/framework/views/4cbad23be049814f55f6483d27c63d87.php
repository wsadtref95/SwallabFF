...
<body>
                    ...
                    <form id="profile-form" action="<?php echo e(route('profile.update')); ?>" method="POST"
                        ...
                        <div class="row">
                            <div class="ml-5 d-flex">
                                <img id="avatar-display"
                                    src="<?php echo e($user->avatar ? asset('storage/' . $user->avatar) : asset('/images/other/default-avatar.jpg')); ?>"
                        ...
                        <div class="ml-5 mt-3 profile">個人簡介：
                            <div class="form-group mt-3 introduce">
                                <textarea class="form-control" id="bio" name="bio" rows="3"><?php echo e($user->bio); ?></textarea>
                            </div>
                        </div>
    ...
    <button class="d-flex delete btn" style="position: absolute; left:903px; bottom:285px" data-toggle="modal" data-target="#changePasswordModal">更改密碼</button>
    <!-- 更改密碼model -->
    ...
    <script>
        ...
        function saveCreditCard() {
            ...
            if (creditCardNumber && expiryDate) {
                fetch('<?php echo e(route('profile.updateCreditCard')); ?>', {
                        method: 'POST',
                        headers: {
        ...
        function openSocialModal(platform) {
            ...
            if (platform.toLowerCase() === 'instagram') {
                userLink = '<?php echo e($user->instagram); ?>';
            } else if (platform.toLowerCase() === 'facebook') {
                userLink = '<?php echo e($user->facebook); ?>';
            } else if (platform.toLowerCase() === 'threads') {
                userLink = '<?php echo e($user->threads); ?>';
            }
        ...
        function saveSocialLink() {
            ...
            if (link) {
                $.ajax({
                    url: '<?php echo e(route('profile.updateSocialLink')); ?>',
                    method: 'POST',
                    data: {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const instagramLink = '<?php echo e($user->instagram); ?>';
            const facebookLink = '<?php echo e($user->facebook); ?>';
            const threadsLink = '<?php echo e($user->threads); ?>';
...
<?php /**PATH C:\xampp\htdocs\swallabLa\swallab\resources\views/profile/edit.blade.php ENDPATH**/ ?>