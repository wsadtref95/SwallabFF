                        ...
                        <div class="row">
                            <div class="ml-5 d-flex">
                                <img id="avatar-display"
                                    src="{{ $user->avatar ? asset( $user->avatar) : asset('/images/other/default-avatar.jpg') }}"
    ...
    <script>
        ...
        function openSocialModal(platform) {
            ...
            if (platform.toLowerCase() === 'instagram') {
                userLink = '{{ $member->ig_link }}';
            } else if (platform.toLowerCase() === 'facebook') {
                userLink = '{{ $member->fb_link }}';
            } else if (platform.toLowerCase() === 'threads') {
                userLink = '{{ $member->threads_link }}';
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const threadsLink = '{{ $member->threads }}';
